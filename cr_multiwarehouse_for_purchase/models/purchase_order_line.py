...
class PurchaseOrder(models.Model):
    ...
    def default_get(self, fields_list):
        ...
        cr_allow_purchase_warehouse = self.env.user.company_id.cr_allow_purchase_warehouse
        result['is_warehouse'] = cr_allow_purchase_warehouse

        return result

    is_warehouse = fields.Boolean(string="warehouse", related="company_id.cr_allow_purchase_warehouse")
...
class PurchaseOrderLineInherit(models.Model):
    ...
    def set_required_warehouse(self):
        cr_allow_purchase_warehouse = self.env['ir.config_parameter'].sudo().get_param(
            'cr_multiwarehouse_for_purchase.cr_allow_purchase_warehouse')
        self.is_warehouse = cr_allow_purchase_warehouse
        if self.product_id:
